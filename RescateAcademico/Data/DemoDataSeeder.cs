...
namespace RescateAcademico.Seeders
{
    public static class DemoDataSeeder
    {
        ...
        private static async Task<List<Tutor>> SeedProfesoresAsync(UserManager<ApplicationUser> um, ApplicationDbContext context)
        {
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                profesores.Add(new Tutor
                {
                    ...
                    NumeroEmpleado = _rng.Next(100000, 9999999).ToString("D7")
                });
            }
        ...
        private static async Task SeedConvocatoriasAsync(ApplicationDbContext context)
        {
            ...
            var modalidades = new[] { "Presencial", "En linea", "Hibrida" };
            var ubicaciones = new[] { "Edificio A - Planta Baja", "Edificio B - Aula 204", "Laboratorio de Cómputo 3", "Biblioteca Central", "Salón 301", "En linea (Teams)", "Laboratorio de Química", "Aula Magna" };
            var horarios = new[] { "Lunes y Miércoles 08:00 - 10:00", "Martes y Jueves 14:00 - 16:00", "Viernes 10:00 - 14:00", "Lunes a Viernes 07:00 - 09:00", "Sábado 09:00 - 13:00", "Horario flexible", "Lunes, Miércoles, Viernes 12:00 - 14:00" };
            context.Convocatorias.AddRange(
                new Convocatoria { Titulo = "Servicio Social en Laboratorios de Cómputo", Descripcion = "Apoyo en laboratorios de cómputo. Requiere promedio mínimo y disponibilidad de horario.", Tipo = "ServicioSocial", ProyectoId = proyectos[0].Id, CupoMaximo = 15, FechaCierre = DateTime.Now.AddDays(45), PromedioMinimo = 7.0m, SemestreMinimo = 3, ValidadaPorAcademia = true, Area = "Ciencias Básicas", Modalidad = modalidades[0], Ubicacion = ubicaciones[2], Horario = horarios[0], RequisitosTecnicos = "Conocimientos básicos de hardware y software.", EstaActiva = true, FechaPublicacion = DateTime.Now.AddDays(-10), PostulacionesActuales = 0 },
                new Convocatoria { Titulo = "Investigación en IA Educativa", Descripcion = "Proyecto de investigación en inteligencia artificial aplicada a la educación.", Tipo = "Investigacion", ProyectoId = proyectos[3].Id, CupoMaximo = 5, FechaCierre = DateTime.Now.AddDays(90), PromedioMinimo = 8.5m, SemestreMinimo = 5, ValidadaPorAcademia = true, Area = "Tecnología", Modalidad = modalidades[2], Ubicacion = ubicaciones[1], Horario = horarios[1], RequisitosTecnicos = "Python, Machine Learning, Estadística.", EstaActiva = true, FechaPublicacion = DateTime.Now.AddDays(-5), PostulacionesActuales = 0 },
                new Convocatoria { Titulo = "Apoyo en Biblioteca Digital", Descripcion = "Digitalización de documentos y soporte en biblioteca.", Tipo = "ApoyoAcademico", ProyectoId = proyectos[1].Id, CupoMaximo = 10, FechaCierre = DateTime.Now.AddDays(30), PromedioMinimo = 6.0m, SemestreMinimo = 2, ValidadaPorAcademia = true, Area = "Humanidades", Modalidad = modalidades[0], Ubicacion = ubicaciones[3], Horario = horarios[2], RequisitosTecnicos = "Manejo de Office y scanners.", EstaActiva = true, FechaPublicacion = DateTime.Now.AddDays(-15), PostulacionesActuales = 0 },
                new Convocatoria { Titulo = "Laboratorio de Química", Descripcion = "Seguimiento de material y bitácoras de laboratorio.", Tipo = "Laboratorio", ProyectoId = proyectos[5].Id, CupoMaximo = 8, FechaCierre = DateTime.Now.AddDays(40), PromedioMinimo = 7.5m, SemestreMinimo = 3, ValidadaPorAcademia = true, Area = "Laboratorio", Modalidad = modalidades[0], Ubicacion = ubicaciones[6], Horario = horarios[3], RequisitosTecnicos = "Química general aprobada.", EstaActiva = true, FechaPublicacion = DateTime.Now.AddDays(-8), PostulacionesActuales = 0 },
                new Convocatoria { Titulo = "Tutorías entre Pares", Descripcion = "Apoyo entre estudiantes para regularización académica.", Tipo = "ApoyoAcademico", ProyectoId = proyectos[4].Id, CupoMaximo = 20, FechaCierre = DateTime.Now.AddDays(25), PromedioMinimo = 7.0m, SemestreMinimo = 2, ValidadaPorAcademia = true, Area = "Formación", Modalidad = modalidades[2], Ubicacion = ubicaciones[1], Horario = horarios[5], RequisitosTecnicos = "Promedio mínimo 8.0 y habilidades de comunicación.", EstaActiva = true, FechaPublicacion = DateTime.Now.AddDays(-12), PostulacionesActuales = 0 },
                new Convocatoria { Titulo = "Diseño de Material Didáctico", Descripcion = "Creación de recursos visuales y multimedia para docentes.", Tipo = "ServicioSocial", ProyectoId = proyectos[6].Id, CupoMaximo = 6, FechaCierre = DateTime.Now.AddDays(35), PromedioMinimo = 7.0m, SemestreMinimo = 3, CarreraRequerida = "Técnico en Informática", ValidadaPorAcademia = true, Area = "Diseño", Modalidad = modalidades[1], Ubicacion = ubicaciones[5], Horario = horarios[5], RequisitosTecnicos = "Adobe Illustrator, Premiere o herramientas similares.", EstaActiva = true, FechaPublicacion = DateTime.Now.AddDays(-7), PostulacionesActuales = 0 },
